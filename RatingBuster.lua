...
LastUpdate: $Date: 2010-10-02 05:15:26 -0500 (Sat, 02 Oct 2010) $
]]
...
RatingBuster.version = "1.5.0 (r"..gsub("$Revision: 286 $", "$Revision: (%d+) %$", "%1")..")"
RatingBuster.date = gsub("$Date: 2010-10-02 05:15:26 -0500 (Sat, 02 Oct 2010) $", "^.-(%d%d%d%d%-%d%d%-%d%d).-$", "%1")
